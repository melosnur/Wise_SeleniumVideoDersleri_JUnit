...
public class C02_DropdownMenu extends TestBase_Each {
    ...
    public void test01(){
       ...
       selectYil.selectByVisibleText("1990");
        ...
        System.out.println(ddmAy.getText()); // text uzerinden hepsini yazdirir
        // ama secim yaptirmaz secim yapmak istiyorsak listeye koymamiz gerekir
        Assertions.assertTrue(ddmAy.getText().contains("Ocak")); //passed
