...
public class C01_OtomatikSonucRaporlama {
    ...
    public void test01(){
        ...
        if (actualUrl.contains(expectedUrlIcerik)){
            ...
            // normalde hepsi calistiginda tik atip geciyor failed passed olduguna bakmiyor
            // hangisini failed hangisinin passed oldugunu vermesi icin
            // AssertionFailedError() kullaniliyor
        }
